...
@NoArgsConstructor
@UdtSqlType("wadm_account_linked_entry")
public class AccountLinkedEntry extends SerializedEntity implements PersistentEntity
{
	@NotNull
	@FormField(flags=FormFieldFlag.HIDDEN|FormFieldFlag.LIST_VISIBLE)// скрыт везде кроме LIST
	private Integer id;
