...
.task.z-listbox, .task.z-tree {
  border-bottom: 1px solid #DDD;
}
.task.z-listbox .z-listitem:hover .z-listitem-checkable,
.task.z-tree .z-treerow:hover .z-treerow-checkable,
 {
  border-color: #FF893C;
}
.task.z-listbox .z-listitem-checkbox,
.task.z-tree .z-treerow-checkbox {
  width: 18px;
  height: 18px;
}
...
.task.z-tree .z-treerow-selected {
  color: #8090A0;
  background-color: #E1EDF4;
}
.task.z-listbox .z-listitem-selected > .z-listcell,
.task.z-tree .z-treerow-selected > .z-treecell {
  background-image: none;
...
.task.z-tree .z-treerow-selected:hover > .z-treecell {
  //border: 1px solid #DDD;
  background-color: transparent;
}

.task.z-listbox .z-listitem:hover > .z-listcell,
.task.z-tree .z-treerow:hover > .z-treecell {
...
.task .z-treecell-content {
    line-height: 24px;
}
.task. z-treerow.z-treerow-selected > .z-treecell > .z-treecell-content {
    color: #636363;
}

.task.z-listbox .z-listitem-selected .z-listcell.text .z-listcell-content,
.task.z-tree .z-treerow-selected .z-treecell.text .z-treecell-content {
  text-decoration: line-through;
  color: #8090A0;
}
...
.task.z-tree .z-treerow .z-treerow-icon.z-icon-check:before {
  content: "\f00c";
}
.task.z-listbox .z-listitem, .task.z-listbox .z-listitem:hover,
.task.z-tree .z-treerow, .task.z-tree .z-treerow:hover {
  /*border-left-width: 3px;*/
}

.task.z-listitem:hover,
.task.z-treerow:hover {
  /*border-left-width: 3px;*/
  background-color: black;
}

.task.z-listitem .z-listcell:hover {
  /*border-left-width: 3px;*/
}
...
.z-datebox-popup.z-datebox-open
{
 	position: absolute !important;
}	
 
.z-datebox-input, .z-timebox-input { // simlar to bootstrap's form-control class
    display: table-cell;
    width: 100%;
    margin-bottom: 0;
    height: 34px;
...
.z-datebox-button, .z-timebox-button { // simlar to bootstrap's input-group-addon class
    padding: 6px 12px;
    font-size: 14px;
    font-weight: normal;
    line-height: 1;
...
.z-timebox-icon.z-timebox-up
{
	position: absolute;
	height: 50%;
	top: 0;
}
.z-timebox-icon.z-timebox-down
{
	position: absolute;
	height: 50%;
	bottom: 0;
...
.z-datebox-popup.z-datebox-open .z-timebox
{
	border-collapse: separate;
    display: table;
    position: relative;
